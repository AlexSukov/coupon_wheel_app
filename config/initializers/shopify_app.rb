ShopifyApp.configure do |config|
  ...
  config.scripttags = [
    {event:'onload', src: 'https://665a769a.ngrok.io/assets/coupon_wheel.coffee' },
    {event:'onload', src: 'https://665a769a.ngrok.io/assets/winwheel.js'},
    {event:'onload', src: 'https://665a769a.ngrok.io/assets/TweenMax.js'}
  ]
end
