ShopifyApp.configure do |config|
  ...
  config.scripttags = [
    {event:'onload', src: 'https://9b9c5d29.ngrok.io/assets/coupon_wheel.coffee' },
    {event:'onload', src: 'https://9b9c5d29.ngrok.io/assets/winwheel.js'},
    {event:'onload', src: 'https://9b9c5d29.ngrok.io/assets/TweenMax.js'}
  ]
end
