ShopifyApp.configure do |config|
  ...
  config.scripttags = [
    {event:'onload', src: 'https://fb2c91df.ngrok.io/assets/coupon_wheel.coffee' },
    {event:'onload', src: 'https://fb2c91df.ngrok.io/assets/winwheel.js'},
    {event:'onload', src: 'https://fb2c91df.ngrok.io/assets/TweenMax.js'}
  ]
end
